  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      for (let i = 0; i < positions.length; i++) {
        ...
        try {
          const response = await axios.get(`http://127.0.0.1:8000/waterpipes/${position}/`);
          const imageData = await axios.get(`http://127.0.0.1:8000/waterpipes/image/${position}/`, {
